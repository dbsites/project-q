/**
 * @module PrivacyPolicy.tsx
 * @description Privacy Policy Presentation Component
 */
  ...
  return (
    <div className="main-dashboard">
      ...
      <div className="dashboard-header dashboard-terms-header">
        <span>
          Ethiq Privacy Policy
        </span>
      </div>
      <div className="terms-dashboard-container">
        <div className="terms-header">
          Effective Date: March 02, 2018
        </div>
        <p>
          Ethiq, Inc. (“Ethiq,” “We,” “Us,” “Our”) is committed to protecting the personal information You (“Beta Tester,” “You,” or a “User”) share and/or store with Us. This Privacy Policy applies to transactions and activities and data gathered through the Ethiq Website and any downloadable Application, as well as any interaction You may have with its related Social Media accounts.
        </p>
        <p>
          We are currently beta testing Services that comprise, generally, aggregating factual data about political contributions made by businesses, as well as available statements and votes made by politicians, media personalities and candidates for office, so that that You and other consumers may easily factor such political engagement into Your own purchasing and voting decisions.
        </p>
        <p>
          In advance of releasing Our Services to the general Public through Our Website and downloadable Application, we are engaging with You, the Beta Testers, to further develop Our Services so that such Services may be prepared for use by Our intended audience in the coming months.
        </p>
        <p>
          This Privacy Policy <strong>does not</strong> address, and We are not responsible for, the privacy, information, or other practices of any third parties, including any third party which We recommend or refer You to, or any third party operating any website to which this Website or Application contains a link. We are committed to providing you with non-partisan and unbiased information, thus, the inclusion of a link on this Website or Application does not imply endorsement of the linked website by Us or by Our affiliates.
        </p>
        <p>
          For questions concerning this Privacy Policy, or Our use of Your personal information, cookies, or similar technologies, please contact us at (<a href="mailto:info@ethiq.org">info@ethiq.org</a>).
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            Providing a better Website and Application,
          </li>
          <li>
        ...
        <p>
          In particular, use of Our Website and Application as a beta tester will require that You disclose a unique email address and/or individualized login credentials to register an account on Our Website.
        </p>
        <p>
            We do not collect personally identifiable information e.g., name, e-mail address, contact or similar information <strong>unless you choose to provide it to us.</strong> If You voluntarily provide Us with personal information, for example by sending an e-mail or by filling out a form and submitting it through Our Website or Application, We may use that information only to respond to your message and to help Us provide You with the information or services that You request.
        </p>
        <p>
        ...
        <p>
          During Your visit to Our Website, We automatically collect and store the following anonymous information about Your visit:
        </p>
        <ul>
          <li>
        ...
        <p>
          We may use this information, in the aggregate, to make our website more useful to Our intended audience, to learn about the number of visitors to Our site and the types of technology used, to detect operational problems, and to improve the website's overall security.
        </p>
        <p>
          <strong>Analytics, Log Files and Reading History</strong>
        </p>
        <p>
          We may gather certain information automatically and store it in log files. This information may include IP addresses, browser type, operating system and other usage information about the use of Our Services, including a history of any Website or Application pages You view.
        </p>
        <p>
        ...
        <p>
          <strong>Disclosure by Necessity</strong>
        </p>
        <p>
        ...
        <p>
          <strong>Children's Guidelines</strong>
        </p>
        <p>
          <strong>COPPA Compliance.</strong> We do not knowingly collect or store any personal information about children under the age of 13.
        </p>
        <p>
