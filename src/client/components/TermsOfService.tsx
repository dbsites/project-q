/**
 * @module TermsOfService.tsx
 * @description Terms of Service Presentation Component
 */
  ...
  return (
    <div className="main-dashboard">
      ...
      <div className="dashboard-header dashboard-terms-header">
        <span>
          Ethiq Participation Terms of Service
        </span>
      </div>
      <div className="terms-dashboard-container">
        ...
        <p>
          If you do not agree with the terms of this Agreement, are under 18 years old, or are not a residing citizen or legal resident of the United States, please do not use the Services or Our Website. If at any time you are <strong>not willing to be bound</strong> by the terms of this Agreement, You should:
        </p>
        <ol type="A">
          <li>
          ...
          <li>
            Terminate any download and/or installation process, and
          </li>
          <li>
        ...
        <p>
          Ethiq hereby grants you a <strong>personal, limited license</strong> to use its Services, including any related Application software as may be made available to you over the course of this Agreement, solely for testing and evaluation purposes, subject to Your compliance with the terms of this Agreement.
        </p>
        <p>
        ...
        <p>
          <strong>Except as expressly set forth herein, no other rights or licenses are granted or to be implied under any Ethiq intellectual property.</strong>
        </p>
        <p>
        ...
        <ol type="i">
          <li>
            The creation of any personally identifying account,
          </li>
          <li>
            The administration of Your account or related membership with Our organization,
          </li>
          <li>
        ...
        <p>
          Please visit Our <Link to='/terms/privacy'>Privacy Policy</Link> for further details on Our data protection policy, including how You may access and correct Your personal information or withdraw consent to the collection, use or disclosure of Your personal information.
        </p>
        <p>
        ...
        <p>
          We reserve the right to amend this Agreement, including the Privacy Policy. Such revisions shall be effective 30 days after posting. We will endeavor to maintain prior versions of the Agreement, if any, for Your reference for the 12-month period preceding the current date, which may be viewed by visiting Our Website (www.ethiq.org/priorterms).
        </p>
        <p>
